...
public class EventManager : MonoBehaviour
{
    ...
    private void Init()
    {
        if (eventDictionary == null) eventDictionary = new Dictionary<Type, UnityEventBase>();
    }
    ...
    public static void StartListening<Tbase>(UnityAction listener) where Tbase : UnityEvent, new()
    {
        ...
        {
            var e = thisEvent as Tbase;

            if (e != null)
                e.AddListener(listener);
            else
                Debug.LogError("EventManager.StartListening() FAILED! Event type " + typeof(Tbase) +
    ...
    public static void StartListening<Tbase, T0, T1>(UnityAction<T0, T1> listener)
        where Tbase : UnityEvent<T0, T1>, new()
    {
        UnityEventBase thisEvent = null;
        if (instance.eventDictionary.TryGetValue(typeof(Tbase), out thisEvent))
        {
    ...
    public static void StartListening<Tbase, T0, T1, T2>(UnityAction<T0, T1, T2> listener)
        where Tbase : UnityEvent<T0, T1, T2>, new()
    {
        UnityEventBase thisEvent = null;
        if (instance.eventDictionary.TryGetValue(typeof(Tbase), out thisEvent))
        {
    ...
    public static void StartListening<Tbase, T0, T1, T2, T3>(UnityAction<T0, T1, T2, T3> listener)
        where Tbase : UnityEvent<T0, T1, T2, T3>, new()
    {
        UnityEventBase thisEvent = null;
        if (instance.eventDictionary.TryGetValue(typeof(Tbase), out thisEvent))
        {
    ...
    public static void StopListening<Tbase>(UnityAction listener) where Tbase : UnityEvent
    {
        ...
        if (instance.eventDictionary.TryGetValue(typeof(Tbase), out thisEvent))
        {
            ...
            if (e != null)
                ...
                Debug.LogError("EventManager.StopListening() FAILED! Event type " + typeof(Tbase) +
                               " could not be accessed for some strange reason.");
        }
    }
    ...
    public static void StopListening<Tbase, T0, T1, T2>(UnityAction<T0, T1, T2> listener)
        where Tbase : UnityEvent<T0, T1, T2>
    {
        if (eventManager == null)
            return;
        UnityEventBase thisEvent = null;
    ...
    public static void StopListening<Tbase, T0, T1, T2, T3>(UnityAction<T0, T1, T2, T3> listener)
        where Tbase : UnityEvent<T0, T1, T2, T3>
    {
        if (eventManager == null)
            return;
        UnityEventBase thisEvent = null;
    ...
    public static void TriggerEvent<Tbase>() where Tbase : UnityEvent
    {
        ...
        if (instance.eventDictionary.TryGetValue(typeof(Tbase), out thisEvent))
        {
            ...
            if (e != null)
                ...
                Debug.LogError("EventManager.TriggerEvent() FAILED! Event type " + typeof(Tbase) +
                               " could not be accessed for some strange reason.");
        }
    }
    ...
    public static void TriggerEvent<Tbase, T0, T1, T2>(T0 t0_obj, T1 t1_obj, T2 t2_obj)
        where Tbase : UnityEvent<T0, T1, T2>
    {
        UnityEventBase thisEvent = null;
        if (instance.eventDictionary.TryGetValue(typeof(Tbase), out thisEvent))
    ...
    public static void TriggerEvent<Tbase, T0, T1, T2, T3>(T0 t0_obj, T1 t1_obj, T2 t2_obj, T3 t3_obj)
        where Tbase : UnityEvent<T0, T1, T2, T3>
    {
        UnityEventBase thisEvent = null;
        if (instance.eventDictionary.TryGetValue(typeof(Tbase), out thisEvent))
